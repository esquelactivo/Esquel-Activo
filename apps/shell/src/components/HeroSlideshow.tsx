  ...
  return (
    ...
    >
      ...
      {slides.length > 1 && (
        <button
          onClick={prev}
          className="absolute left-10 top-1/2 -translate-y-1/2 rounded-full bg-black/30 p-2 text-white backdrop-blur-sm transition-colors hover:bg-black/50"
      ...
      {slides.length > 1 && (
        <button
          onClick={next}
          className="absolute right-10 top-1/2 -translate-y-1/2 rounded-full bg-black/30 p-2 text-white backdrop-blur-sm transition-colors hover:bg-black/50"
