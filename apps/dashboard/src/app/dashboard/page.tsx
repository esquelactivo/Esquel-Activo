...
async function getStats(schemaName: string) {
  // En Fase 3 estas queries se harán sobre el schema del tenant.
  // Por ahora devolvemos datos placeholder.
  return {
    ordersToday: 0,
    pendingOrders: 0,
    totalProducts: 0,
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-3 md:grid-cols-3">
        ...
        <StatCard label="Productos" value="0" icon="🛍️" className="col-span-2 md:col-span-1" />
      </div>
